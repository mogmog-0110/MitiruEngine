 ...
 * 理由: JS からの physics 命令 dispatch + RAF poll で simulation の駆動主体が
 * JS になり、bridge 規約 (JS→C++ は入力 / UI イベント通知のみ、ADR 0005) を破る。
 * 移行先: simulation は C++ が所有して state を push。JS からの命令 dispatch は廃止。
