 ...
 * 理由: JS 側 action-map + Gamepad polling は InputSnapshot (C ABI) の外の
 * 入力経路で、決定論 replay (軸④) から漏れる (ADR 0005 違反)。
 * 移行先: 入力は host の InputSnapshot に一本化。UI からの通知は data-m-action。
